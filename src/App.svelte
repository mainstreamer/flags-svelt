<script>
  ...
  let urlBase = 'http://flags.tldr.icu/capitals';
    ...
    <hr>
        ...
        {#each data.options as option}
          <div class="container">
            ...
            {#if answerResult}
              <div class="box-r title"> <div class="flag text"><span class="large-text">{option.flag}</span></div> <div class="text">{option.country}</div> </div>
            {/if}
          </div>
        {/each}
